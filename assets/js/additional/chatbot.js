...
function open_new_chat() {
  ...
  <div class="row justify-content-center py-2 pt-5" id="new_chat_info" style="padding-left: 20%; padding-right:20%">
      <div class="col-md-4 text-center">
          ...
          <button type="button" onclick="enter_prompt('How can I find information about campus events?')" class="btn btn-outline-dark mb-2">How can I find information about campus events?</button><br>
          <button type="button" onclick="enter_prompt('Can I register and apply for events online?')" class="btn btn-outline-dark">Can I register and apply for events online?</button>
      </div>
      <div class="col-md-4 text-center">
