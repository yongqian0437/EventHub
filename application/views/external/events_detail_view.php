                    ...
                    <div class="d-flex container py-4">
                        <?php if (!empty($event_data)) {
                            foreach ($event_data as $events) { ?>
                                <div class="col-12">
                                    <div class="event-cover-img" style="background-image: url('<?php echo base_url("assets/img/universities/") . $uni_data->uni_background; ?>');">
                                        <div class="fallbak">
                                            <div class="row">
                                                <div class="col-4">
                                            ...
                                            <div class="col-12 d-flex justify-content-center mb-3">
                                                <div class="row">
                                                    <div>
                                                        ...
                                                        <?php } ?>
                                                        <a type="button" target="_blank" href="<?php echo base_url() . 'external/Universities/university_detail/' . $events->uni_id ?>" class="btn btn-secondary event-ave-buttons">View Organizer</a>
