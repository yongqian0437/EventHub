...
<!-- Topbar -->
<nav class="navbar sticky-top navbar-expand topbar" style="background-color: #61677A;">

    <!-- Logo Image-->
    <!-- <nav class="navbar navbar-light bg-light">   -->
    <a class="navbar-brand py-0 " href="<?php echo base_url('external/homepage'); ?>">
        <img src="<?php echo base_url('assets/img/eventhub-logo.png'); ?>" height="70" alt="logo">
    </a>
    <!-- </nav> -->
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item px-2">
            <a class="nav-link" href="<?php echo base_url('external/courses'); ?>">Event</a>
        </li>
        ...
        <?php } else { ?>
            <li class="nav-item pl-1">
                <a class="nav-link" href="<?= base_url('user/login/Auth/login'); ?>">
                    <button type="button" id="register_btn" class="btn" style="background-color: white; color: #272829; font-size: 0.9em; border-radius:15px; font-weight: 800;">Login / Register</button>
                </a>
            </li>
        <?php } ?>
