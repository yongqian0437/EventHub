            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><?= $university_data->uni_name ?>'s Events</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 ">
                            <div class="d-flex justify-content-end">
                                <a type="button" href="<?= base_url('internal/level_2/educational_partner/ep_courses/add_course'); ?>" class="btn btn-primary">Add an Event<i class="fas fa-plus pl-2"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- Content Row -->
                        ...
                        <div class="modal-dialog modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color:#6B9080;">
                                    <h5 class="modal-title" id="view_courseLabel" style="color:white;">Event Information</h5>
