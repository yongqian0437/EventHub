...
<?php if ($this->session->flashdata('insert_message')) { ?>
    <script>
        var eventName = "<?php echo $this->session->flashdata('event_name'); ?>";
        Swal.fire({
            icon: 'success',
...
<?php if ($this->session->flashdata('edit_message')) { ?>
    <script>
        ...
        Swal.fire({
            icon: 'success',
            text: '"' + eventName + '" has been edited',
        })
    </script>
<?php } ?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><?= $event_data->organizer_name ?>'s Events</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 ">
                            <div class="d-flex justify-content-end">
                                <a type="button" href="<?= base_url('internal/level_2/educational_partner/ep_events/add_event'); ?>" class="btn btn-primary">Add an Event<i class="fas fa-plus pl-2"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- Content Row -->
                            ...
                            <div class="card ">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="table_events" class="table table-striped">
                                            <thead>
                                                <tr>
                                                    <th>No.</th>
                                                    <th>Event Name</th>
