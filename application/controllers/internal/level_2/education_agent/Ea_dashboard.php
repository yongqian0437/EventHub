...
class Ea_dashboard extends CI_Controller
{
	...
	public function index()
	{
		...
		// Total Student
		$data['total_students'] = count($this->event_applicants_model->get_total_students($this->session->userdata('user_id')));
		// var_dump($data['total_student']);
		// die;
		//get nationality
		$data['total_applicants'] = $this->event_applicants_model->applicants_per_nationality($this->session->userdata('user_id'));
