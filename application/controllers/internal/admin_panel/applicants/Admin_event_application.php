        ...
        <table class="table table-striped" style = "border:0;">
            <tbody>
                ...
                <tr style="text-align:center;">
                    <td colspan="2"><img src="' . base_url("assets/img/universities/") . $event_applicants[0]->uni_logo . '" style="width: 250px; height: 100px; object-fit:contain;">
                    </td>  
                </tr>
                <tr>
                    <th scope="row">University</th>
                    <td>' . $event_applicants[0]->uni_name . '</td>
                </tr>
                <tr>
                    <th scope="row">Country</th>
                    <td>' . $event_applicants[0]->uni_country . '</td>
                </tr>
                <tr>
